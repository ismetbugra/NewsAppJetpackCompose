package com.example.newsappcompose.utils.network
...
// bu state NetworkConnectionState classı turunden deger dondurecek Available veya UnAvailable donecek bu değerlere göre bağlantı kontrol edilecek
@Composable
